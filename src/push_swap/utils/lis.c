...
/*   Updated: 2025/06/02 22:14:01 by amagno-r         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	reconstruct_sequence(int arr[], int *parent, int max_index,
	int *sequence)
{
	int	i;
	int	j;
...
int	lis_with_sequence(int arr[], int n, int **sequence)
{
	...
	*sequence = (int *)malloc(max_length * sizeof(int));
	...
	reconstruct_sequence(arr, parent, max_index, *sequence);
